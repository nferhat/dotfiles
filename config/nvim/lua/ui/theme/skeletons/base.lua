...
return {
    ...
    floatborder = { bg = C.light_background, fg = C.border },
    bold = { bold = true },
    ...
    foldcolumn = { fg = C.color6, bg = C.light_background },
    folded = { fg = C.comment, italic = true },
    ...
    pmenuthumb = { fg = C.color8, bg = C.color8 },
