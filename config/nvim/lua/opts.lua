...
-- O.winblend = 7
-- O.pumblend = 7
O.shortmess:append("socCTW") -- disable nvim intro + completion messages
...
vim.api.nvim_create_autocmd("FileType", {
	...
	callback = function(ev)
		...
		if lang ~= nil and vim.treesitter.query.get(lang, "highlights") ~= nil then
