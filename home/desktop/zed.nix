{
  ...
  xdg.configFile = {
    ...
    "zed/keymap.json".source = config.lib.file.mkOutOfStoreSymlink "/home/nferhat/Documents/repos/personal/dotfiles/config/zed/keymap.json";
    "zed/themes/fht.json" = let
      theme = import ../../theme;
